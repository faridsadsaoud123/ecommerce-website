...
export const USER_DATAILS_REQUEST = "USER_DATAILS_REQUEST";
export const USER_DATAILS_SUCCESS = "USER_DATAILS_SUCCESS";
export const USER_DATAILS_FAIL = "USER_DATAILS_FAIL";
